...
interface InlineDiffProps {
  original: string;
  current: string;
  /** What the two sides ARE. Defaults to the seed-vs-now comparison this started as; the
   * take-vs-text re-baseline confirmation passes its own so the reader isn't told they're
   * looking at the original when they aren't. */
  label?: string;
}
 ...
 */
const InlineDiff = ({ original, current, label = 'Original → new' }: InlineDiffProps) => {
